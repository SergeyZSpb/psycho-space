...
var (
	...
	ErrShiftInProgress = errors.New("gamekaren: a shift is already in progress")
	...
	ErrNoShift = errors.New("gamekaren: no shift in progress")
	...
	ErrOfficeFull = errors.New("gamekaren: the office is full")
)
