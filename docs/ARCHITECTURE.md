...
| ← client | `fintech_ready` | `shift_id` | Which shift this socket is now watching. A hello with no shift gets **silence** — a socket that opened before the shift did is not an error. |
